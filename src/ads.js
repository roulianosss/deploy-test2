...
const components = [{
    ...
    name: "iconButton", template: iconButton
}, {
    name: "toggleButton", template: toggleButton
}, {
    name: "tab", template: tab
}, {
    name: "link", template: link
}, {
    name: "fileLink", template: fileLink
}, {
    name: "tag", template: tag
}
...
const patterns = [{
    name: "breadcrumb", template: breadcrumb
}, {
    name: "tabsNavigation", template: tabsNavigation
}, {
    name: "keypointCard", template: keypointCard
}, {
    name: "articleCard", template: articleCard
}, {
    name: "awardItem", template: awardItem
}, {
    name: "feeCard", template: feeCard
}, {
    name: "managementGuidedCard", template: managementGuidedCard
}, {
    name: "managementOthersCard", template: managementOthersCard
}]

const blocks = [{
    name: "header", template: header
}, {
    name: "footer", template: footer
}, {
    name: "wrapper (66/33 - 50/50 - 33/66)", template: wrapper
}, {
    name: "homeHeroBanner", template: homeHeroBanner
}, {
    name: "promoBanner", template: promoBanner
}, {
    name: "companyValueSection", template: companyValueSection
}, {
    name: "advicesSection", template: advicesSection
}, {
    name: "insurancePartnersSection", template: insurancePartnersSection
}, {
    name: "investmentDisclaimerSection", template: investmentDisclaimerSection
}, {
    name: "awardsSection", template: awardsSection
}, {
    name: "reviewsSection", template: reviewsSection
}, {
    name: "partnerNewsSection", template: partnerNewsSection
}, {
    name: "productHeroBanner", template: productHeroBanner
}, {
    name: "productAdvantagesSection", template: productAdvantagesSection
}, {
    name: "productManagementSection", template: productManagementSection
}, {
    name: "productInsurancePartnerSection", template: productInsurancePartnerSection
}, {
    name: "productContractualDocumentationSection", template: productContractualDocumentationSection
}, {
    name: "productFeesSection", template: productFeesSection
}, {
    name: "faqRedirectionSection", template: faqRedirectionSection
}, {
    name: "managementAdvantagesSection", template: managementAdvantagesSection
}, {
    name: "managementPlusSection", template: managementPlusSection
}, {
    name: "assetsSupportSection", template: assetsSupportSection
}, {
    name: "assetsPilotedSection", template: assetsPilotedSection
}, {
    name: "partnerPilotedSection", template: partnerPilotedSection
}, {
    name: "headerPilotedSection", template: headerPilotedSection
}, {
    name: "headerSupportSection", template: headerSupportSection
}, {
    name: "contractsPilotedSection", template: contractsPilotedSection
}, {
    name: "contractsSupportSection", template: contractsSupportSection
}, {
    name: "altaNewsTalkingAboutSection", template: altaNewsTalkingAboutSection
}, {
    name: "webconferencesSection", template: webconferencesSection
}, {
    name: "pressSection", template: pressSection
}, {
    name: "expertsVoiceSection", template: expertsVoiceSection
}, {
    name: "headerExpertsVoiceSection", template: headerExpertsVoiceSection
}, {
    name: "discoverIntegrationProgramSection", template: discoverIntegrationProgramSection
}, {
    name: "questionsSection", template: questionsSection
}, {
    name: "squadSection", template: squadSection
}, {
    name: "altaInNumberSection", template: altaInNumberSection
}, {
    name: "altaprofitHistorySection", template: altaprofitHistorySection
}, {
    name: "reasonToJoinSection", template: reasonToJoinSection
}, {
    name: "discoverOurJobSection", template: discoverOurJobSection
}, {
    name: "joinTheTeamSection", template: joinTheTeamSection
}]
