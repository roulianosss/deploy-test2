(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const c of n)if(c.type==="childList")for(const e of c.addedNodes)e.tagName==="LINK"&&e.rel==="modulepreload"&&s(e)}).observe(document,{childList:!0,subtree:!0});function l(n){const c={};return n.integrity&&(c.integrity=n.integrity),n.referrerPolicy&&(c.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?c.credentials="include":n.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function s(n){if(n.ep)return;n.ep=!0;const c=l(n);fetch(n.href,c)}})();const R=`<a class="button button--primary" href="#"> Button</a>\r
\r
...
</header>`,K=`<footer class="footer">\r
...
`,Mn=[{name:"header",template:Y},{name:"footer",template:K},{name:"wrapper (66/33) (50/50) (33/66)",template:X},{name:"homeHeroBanner",template:nn},{name:"promoBanner",template:en},{name:"companyValueSection",template:rn},{name:"advicesSection",template:tn},{name:"insurancePartnersSection",template:sn},{name:"investmentDisclaimerSection",template:an},{name:"awardsSection",template:on},{name:"reviewsSection",template:cn},{name:"partnerNewsSection",template:ln},{name:"heroBanner (Default, Catchline, Product)",template:dn},{name:"productAdvantagesSection",template:vn},{name:"productManagementSection",template:_n},{name:"productInsurancePartnerSection",template:pn},{name:"productContractualDocumentationSection",template:un},{name:"productFeesSection",template:mn},{name:"faqRedirectionSection",template:gn},{name:"managementAdvantagesSection",template:hn},{name:"managementPlusSection",template:bn},{name:"managementOthersOverviewSection",template:fn},{name:"managementGuidedOverviewSection",template:wn},{name:"managementGuidedPartnersSection",template:yn},{name:"contractsPilotedSection",template:xn},{name:"contractsSupportSection",template:Cn},{name:"altaNewsTalkingAboutSection",template:Ln},{name:"webconferencesSection",template:qn},{name:"pressSection",template:kn},{name:"expertsVoiceSection",template:En},{name:"discoverIntegrationProgramSection",template:An},{name:"questionsSection",template:Pn},{name:"squadSection",template:Sn},{name:"altaInNumberSection",template:zn},{name:"altaprofitHistorySection",template:Rn},{name:"reasonToJoinSection",template:jn},{name:"discoverOurJobSection",template:Vn},{name:"joinTheTeamSection",template:In},{name:"pilotedGraphSection",template:Tn}],Bn=[{name:"components",value:U},{name:"patterns",value:W},{name:"blocks",value:Mn}];Bn.forEach(o=>{const r=document.createElement("section");r.classList.add("ads",o.name);const l=document.createElement("h3");l.innerText=o.name.toUpperCase(),r.appendChild(l),o.value.forEach(s=>{const n=document.createElement("div");n.id=s.name,n.classList.add("section","ads");const c=document.createElement("h4");c.innerText=s.name,n.appendChild(c);const e=document.createElement("div");e.innerHTML=s.template,e.classList.add("sub-section","ads"),n.appendChild(e),r.appendChild(n)}),document.querySelector("main.ads").appendChild(r)});const A=document.querySelectorAll(".management-others-card");if(A){let o=0;A.forEach(r=>{const l=r.querySelectorAll(".management-others-card__explaination");for(let n=0;n<l.length;n++){const e=l[n].offsetHeight;e>o&&(o=e)}r.querySelector(".management-others-card__explainations").style.setProperty("height",`calc(${o}px + var(--spacing-8))`),r.querySelectorAll(".management-others-card__link").forEach(n=>{let c=n.dataset.name,e=r.querySelector(".management-others-card__explaination[data-name="+c+"]");n.addEventListener("mouseenter",()=>{e.classList.add("active")}),n.addEventListener("mouseleave",()=>{e.classList.remove("active")})})})}if(document.querySelector(".header")){let l=function(){t(o),s(o)},s=function(d){d.forEach(u=>{u.addEventListener("click",v=>{v.preventDefault(),n(),c(u)})})},n=function(){o.forEach(d=>{d.classList.remove("active")})},c=function(d){d.classList.add("active")},e=function(d){return d.getBoundingClientRect().right},t=function(d){d.forEach(u=>{const v=u.querySelector(".expand-menu");e(v)>e(r)?(u.classList.add("menu__item--right"),u.classList.remove("menu__item--left")):(u.classList.remove("menu__item--right"),u.getAttribute("data-position")==="left"&&u.classList.add("menu__item--left"))})};var init=l,displayExpandMenuItems=s,removeCurrentItemClass=n,addItemClass=c,getElementRightPosition=e,placeMenuItems=t;const o=document.querySelectorAll(".menu__item"),r=document.querySelector(".header__menu");window.addEventListener("resize",()=>{t(o)}),l()}const P={speed:200},S=document.querySelectorAll(".awards-section");S&&S.forEach(o=>{const r=o.querySelector(".awards-section__content"),l=r.cloneNode(!0);r.classList.add("primary"),l.classList.add("secondary"),r.parentNode.appendChild(l);const s=r.querySelectorAll(".award-item").length;r.style.setProperty("animation",`awards-section--primary ${s*1e3/P.speed}s linear infinite`),l.style.setProperty("animation",`awards-section--secondary ${s*1e3/P.speed}s linear infinite`)});if(document.querySelector(".contracts-piloted-section-container")){let g=function(){if(console.dir(this),this.nextElementSibling.style.maxHeight)console.dir(this.nextElementSibling),this.nextElementSibling.style.maxHeight="",this.lastElementChild.style.transform="rotate(0deg)";else{const i=this.nextElementSibling.scrollHeight;this.nextElementSibling.style.maxHeight=`${i}px`,this.lastElementChild.style.transform="rotate(180deg)"}};var handleClick=g;const o={assuranceVie:{titresVie:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.13%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 2",srri:3,percentageRate:"-3%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 3",srri:3,percentageRate:"-3%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]},altaprofitsVie:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 2",srri:7,percentageRate:"-4.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 3",srri:6,percentageRate:"-9.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]},digitalViePrime:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]},espaceLuxVie:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 2",srri:3,percentageRate:"-3%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"},{title:"Profil 1",srri:6,percentageRate:"-5.53%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]}},capitalisation:{titreCapi:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]},altaprofitsCapitalisation:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]},digitalCapiPrime:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]}},planEpargneRetraite:{titrePER:{prudent:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],balanced:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}],dynamic:[{title:"Carte Blanche",srri:5,percentageRate:"-7.33%",informations:"Performances cumulées sur 5 ans",iconUrl:"./assets/logos/lazard_freres_gestion--fit.svg"}]}}},r=document.querySelectorAll(".btns-container__first-choice-container__btn"),l=document.querySelector(".btns-container__second-choice-container"),s=document.querySelectorAll(".btns-container__second-choice-container__btns-type-second-choice-container__btn"),n=document.querySelectorAll(".filters-container__btns-container__btn"),c=document.querySelectorAll(".btns-container__second-choice-container__btns-type-second-choice-container"),e=document.querySelector(".results-container"),t=document.querySelectorAll(".toggle-button"),d=document.querySelectorAll(".card-container, .grid-row-body"),u=document.querySelector(".cards-display-container"),v=document.querySelector(".array-display-container");document.querySelectorAll(".grid-row-body"),document.querySelector(".distribution-funds-array-section__btn").addEventListener("click",g);const m={firstChoice:"",secondChoice:"",thirdChoice:"prudent"};r.forEach(i=>i.addEventListener("click",()=>f(i))),s.forEach(i=>i.addEventListener("click",()=>h(i))),n.forEach(i=>i.addEventListener("click",()=>y(i))),t.forEach(i=>i.addEventListener("click",()=>L())),d.forEach(i=>i.addEventListener("click",()=>x(i)));const f=i=>{m.secondChoice="",s.forEach(p=>p.classList.remove("btns-container__second-choice-container__btns-type-second-choice-container__btn--active")),r.forEach(p=>p.classList.remove("btns-container__first-choice-container__btn--active")),c.forEach(p=>p.classList.add("hidden")),i.classList.add("btns-container__first-choice-container__btn--active"),m.firstChoice=i.getAttribute("data-attr"),l.classList.remove("hidden"),document.querySelector(`.${i.getAttribute("data-attr")}`).classList.remove("hidden"),w()},h=i=>{s.forEach(p=>p.classList.remove("btns-container__second-choice-container__btns-type-second-choice-container__btn--active")),m.secondChoice=i.getAttribute("data-attr"),i.classList.add("btns-container__second-choice-container__btns-type-second-choice-container__btn--active"),w()},y=i=>{m.thirdChoice=i.getAttribute("data-attr"),n.forEach(p=>p.classList.remove("filters-container__btns-container__btn--active")),i.classList.add("filters-container__btns-container__btn--active"),w()},w=()=>{m.firstChoice!==""&&m.secondChoice!==""?e.classList.remove("hidden"):e.classList.add("hidden"),v.innerHTML="",u.innerHTML="";const i=o[m.firstChoice][m.secondChoice][m.thirdChoice];i.map(p=>u.innerHTML+=`
    ...
    `),document.querySelectorAll(".card-container, .grid-row-body").forEach(p=>p.addEventListener("click",()=>x(p)))},L=i=>{t.forEach(p=>{p.classList.toggle("toggle-button--active")}),C()},x=i=>{C(),document.querySelectorAll(".card-container, .grid-row-body").forEach(p=>p.classList.remove("card-container--active")),i.classList.add("card-container--active")},C=()=>{t.forEach(i=>{i.classList.contains("btn-parameter1")&&i.classList.contains("toggle-button--active")?u.classList.remove("hidden"):i.classList.contains("btn-parameter1")&&!i.classList.contains("toggle-button--active")&&u.classList.add("hidden"),i.classList.contains("btn-parameter2")&&i.classList.contains("toggle-button--active")?v.classList.remove("hidden"):i.classList.contains("btn-parameter2")&&!i.classList.contains("toggle-button--active")&&v.classList.add("hidden")})}}if(document.querySelector(".contracts-support-section-container")){const o={assuranceVie:{titresVie:{euro:[{title:"Fonds euros SwissLife",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"}]},digitalViePrime:{euro:[{title:"Suravenir Opportunité 2",percentageRate:"-7.83%",informations:"PPerformances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"},{title:"Suravenir Rendement 2",percentageRate:"-6.83%",informations:"Performances nettes⁽¹⁾;en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"}]},altaprofitsVie:{euro:[{title:"Netissima",percentageRate:"Jusqu'à&nbsp;3.06%",informations:"Performances nettes⁽¹⁾ en 2022 <br />Voir les conditions d'accès",iconUrl:"./assets/logos/generali--fit.svg"},{title:"Eurossima",percentageRate:"1.30%(3)<br/>1.35%(4)",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/generali--fit.svg"}]},espaceLuxVie:{euro:[{title:"Fonds Général",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/generali--fit.svg"}]}},capitalisation:{altaprofitsCapitalisation:{euro:[{title:"Netissima",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/generali--fit.svg"},{title:"Eurossima",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/generali--fit.svg"}]},titreCapi:{euro:[{title:"Fonds euros Swisslife",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"}]},digitalCapiPrime:{euro:[{title:"Suravenir Opportunité 2",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"},{title:"Suravenir Rendement 2",percentageRate:"-5.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"}]}},planEpargneRetraite:{titrePER:{euro:[{title:"Fonds euros SwissLife spécial PER",percentageRate:"-7.83%",informations:"Performances nettes⁽¹⁾ en 2022",iconUrl:"./assets/logos/swisslife--fit.svg"}]}}},r={firstChoice:"",secondChoice:"",thirdChoice:""},l=document.querySelectorAll(".support-btns-container__first-choice-container__btn"),s=document.querySelector(".support-btns-container__second-choice-container"),n=document.querySelectorAll(".support-btns-container__second-choice-container__btns-type-second-choice-container"),c=document.querySelector(".btns-third-choice-container"),e=document.querySelectorAll(".support-btns-container__second-choice-container__btns-type-second-choice-container__btn"),t=document.querySelectorAll(".btns-third-choice-container__btn"),d=document.querySelectorAll(".account-unit-container__btns-container__btn"),u=document.querySelector(".euro-fund-container"),v=document.querySelector(".growth-fund-container"),b=document.querySelector(".euro-fund-container__netissima-container"),g=document.querySelector(".growth-container"),m=document.querySelectorAll(".grid-row-body"),f=document.querySelector(".structured-fund-container"),h=document.querySelector(".account-unit-container"),y=document.querySelector(".tunnel-array-container"),w=document.querySelector(".euro-fund-container__cards-container"),L=document.querySelectorAll(".support-card-container");document.querySelector(".white-card-container"),document.querySelector(".array-container"),l.forEach(a=>a.addEventListener("click",()=>x(a))),e.forEach(a=>a.addEventListener("click",()=>C(a))),t.forEach(a=>a.addEventListener("click",()=>i(a))),d.forEach(a=>a.addEventListener("click",()=>p(a))),L.forEach(a=>a.addEventListener("click",()=>k(a))),m.forEach(a=>a.addEventListener("click",()=>setActiveRow(a)));const x=a=>{l.forEach(_=>_.classList.remove("support-btns-container__first-choice-container__btn--active")),e.forEach(_=>_.classList.remove("support-btns-container__second-choice-container__btns-type-second-choice-container__btn--active")),t.forEach(_=>_.classList.remove("btns-third-choice-container__btn--active")),u.classList.add("hidden"),h.classList.add("hidden"),v.classList.add("hidden"),c.classList.add("hidden"),a.classList.add("support-btns-container__first-choice-container__btn--active"),s.classList.remove("hidden"),n.forEach(_=>_.classList.add("hidden")),r.secondChoice="",r.thirdChoice="",r.firstChoice=a.getAttribute("data-attr"),s.classList.remove("hidden"),document.querySelector(`.support-btns-container__second-choice-container__btns-type-second-choice-container.${a.getAttribute("data-attr")}`).classList.remove("hidden"),E()},C=a=>{t.forEach(_=>_.classList.remove("btns-third-choice-container__btn--active")),c.classList.add("hidden"),u.classList.add("hidden"),h.classList.add("hidden"),v.classList.add("hidden"),e.forEach(_=>_.classList.remove("support-btns-container__second-choice-container__btns-type-second-choice-container__btn--active")),r.secondChoice=a.getAttribute("data-attr"),a.classList.add("support-btns-container__second-choice-container__btns-type-second-choice-container__btn--active"),c.classList.remove("hidden"),E(),q()},i=a=>{r.thirdChoice=a.getAttribute("data-attr"),t.forEach(_=>_.classList.remove("btns-third-choice-container__btn--active")),a.classList.add("btns-third-choice-container__btn--active"),z(a.getAttribute("data-attr")),q()},p=a=>{d.forEach(_=>_.classList.remove("account-unit-container__btns-container__btn--active")),a.classList.add("account-unit-container__btns-container__btn--active"),a.getAttribute("data-attr")!=="structured-funds"?(y.classList.remove("hidden"),f.classList.add("hidden")):(y.classList.add("hidden"),f.classList.remove("hidden"))},k=a=>{document.querySelectorAll(".support-card-container").forEach(_=>_.classList.remove("support-card-container--active")),a.classList.add("support-card-container--active"),a.getAttribute("data-attr")==="Netissima"?b.classList.remove("hidden"):b.classList.add("hidden"),a.getAttribute("data-attr")==="growth-netissima"?g.classList.remove("hidden"):g.classList.add("hidden")},E=()=>{r.firstChoice==="assuranceVie"&&r.secondChoice==="altaprofitsVie"||r.firstChoice==="capitalisation"&&r.secondChoice==="altaprofitsCapitalisation"?document.querySelector(".btns-third-choice-container__btn.growth").classList.remove("hidden"):document.querySelector(".btns-third-choice-container__btn.growth").classList.add("hidden"),r.firstChoice!=="planEpargneRetraite"&&r.secondChoice!=="titrePER"?document.querySelector(".btns-third-choice-container__btn.unit").classList.remove("hidden"):document.querySelector(".btns-third-choice-container__btn.unit").classList.add("hidden")},z=a=>{a==="euro"?(u.classList.remove("hidden"),q()):u.classList.add("hidden"),a==="growth"?v.classList.remove("hidden"):v.classList.add("hidden"),a==="unit"?h.classList.remove("hidden"):h.classList.add("hidden")},q=()=>{w.innerHTML="";const a=o[r.firstChoice][r.secondChoice][r.thirdChoice];a==null||a.map(_=>w.innerHTML+=`
  ...
  `),document.querySelectorAll(".support-card-container").forEach(_=>_.addEventListener("click",()=>k(_)))}}if(document.querySelector(".alta-news-talking-about-container")){let c=function(e){s.forEach(t=>{t.getAttribute("data-attr")===e&&t.classList.add("activePage")}),n.innerHTML="",o.slice((e-1)*4,e*4).forEach(t=>n.innerHTML+=`
...
`)};var displayNews=c;const o=[{date:"22 Juillet 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"21 Juin 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"2 Juin 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"15 Mai 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"10 Mai 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"26 Avril 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"31 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"11 Mars 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"10 Mars 2022",title:"Quelle stratégie pour créer de la performance dans un contexte inflationniste ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/bfm_business.png"},{date:"22 Février 2022",title:"Assurance vie : comment profiter des rendements du non coté",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/capital.png"},{date:"12 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/money_vox.png"},{date:"10 Février 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"},{date:"9 Janvier 2022",title:"Assurance vie : peut-on craindre un blocage des retraits ?",description:"“L'année 2022 ne sera pas celle du fonds en euros de l'assurance vie ! Alors que le taux du Livret A sera de 2% au 1er août, peu de fonds à capital... ",logoUrl:"./assets/logos/le_revenu.png"}],r=document.querySelector(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers"),l=Math.ceil(o.length/4);r.innerHTML="";for(let e=1;e<=l;e++)r.innerHTML+=`
        ...
        `;const s=document.querySelectorAll(".alta-news-talking-about-container__left-container__pages-navigation__pages-numbers__btn");s.forEach(e=>e.addEventListener("click",t=>{s.forEach(d=>d.classList.remove("activePage")),c(t.target.getAttribute("data-attr"))}));const n=document.querySelector(".alta-news-talking-about-container__left-container__news-container");c(1)}if(document.querySelector(".experts-voice-section")){let c=function(t){s.forEach(d=>{d.getAttribute("data-attr")===t&&d.classList.add("active")}),n.innerHTML="",o.slice((t-1)*3,t*3).forEach(d=>n.innerHTML+=`
...
`)};var displayNews=c;const o=[{date:"13 novembre 2022",title:"Investissement responsable : quelle est la valeur ajoutée des ETF intégrant les considérations ESG ?",description:"Les stratégies d'investissement intégrant des critères environnementaux, sociaux et de gouvernance dits “ESG” sont devenues incontournables. ",author:"Par <b>Cyrille Chambron</b>, Gérant allocataire chez Amundi",logoUrl:"/assets/images/parole-d-expert.png"},{date:"21 novembre 2022",title:"SCPI : en quoi l’immobilier en région est source d’opportunités ?",description:"Jean-Marie Souclier, Président chez Sogenial Immobilier, nous explique pourquoi les régions françaises constituent des zones d’investissement recherchées pour les investisseurs en quête de rendement et de diversification.",author:"Par <b>Jean-Marie Souclier</b>, Président chez Sogenial",logoUrl:"/assets/images/parole-d-expert.png"},{date:"13 décembre 2022",title:"Pourquoi choisir un fonds à échéance pour s’exposer à la classe d’actifs obligataire ?",description:"Avec la remontée des taux, les rendements des obligations sont redevenus attractifs. Pourquoi cela constitue un environnement favorable pour les fonds à échéance ?",author:"Par <b>Emmanuel de Sinety</b>, Gérant obligataire chez Sycomore AM",logoUrl:"/assets/images/parole-d-expert.png"},{date:"13 décembre 2022",title:"Pourquoi choisir un fonds à échéance pour s’exposer à la classe d’actifs obligataire ?",description:"Avec la remontée des taux, les rendements des obligations sont redevenus attractifs. Pourquoi cela constitue un environnement favorable pour les fonds à échéance ?",author:"Par <b>Emmanuel de Sinety</b>, Gérant obligataire chez Sycomore AM",logoUrl:"/assets/images/parole-d-expert.png"},{date:"13 décembre 2022",title:"Pourquoi choisir un fonds à échéance pour s’exposer à la classe d’actifs obligataire ?",description:"Avec la remontée des taux, les rendements des obligations sont redevenus attractifs. Pourquoi cela constitue un environnement favorable pour les fonds à échéance ?",author:"Par <b>Emmanuel de Sinety</b>, Gérant obligataire chez Sycomore AM",logoUrl:"/assets/images/parole-d-expert.png"}],r=document.querySelector(".experts-voice-section__pagination"),l=Math.ceil(o.length/3);r.innerHTML="";for(let t=1;t<=l;t++)r.innerHTML+=`
  ...
  `});const l=document.querySelectorAll(".history-section__cards-section__cards__card");document.querySelectorAll(".history-section__cards-section__right-arrow, .history-section__cards-section__left-arrow").forEach(e=>e.addEventListener("click",c));let n=0}if(document.querySelector(".discover-our-job")){let n=function(){let e=0;e=(r.length-1)*-100,this.classList.contains("discover-our-job__card-section__right-arrow")&&s>e?s-=100:this.classList.contains("discover-our-job__card-section__right-arrow")&&s<=e?s=0:this.classList.contains("discover-our-job__card-section__left-arrow")&&s<0?s+=100:this.classList.contains("discover-our-job__card-section__left-arrow")&&s===0&&(s=e),r.forEach(t=>t.style.transform=`translateX(${s}%)`)};var handleArrowClick=n;[{name:"Jules",job:"Conseiller Patrimonial",description:"“Ce qui me challenge tous les jours ? <br/> La satisfaction client”",photoUrl:"/assets/images/jules-portrait.png"},{name:"Jules",job:"Conseiller Patrimonial",description:"“Ce qui me challenge tous les jours ? <br/> La satisfaction client”",photoUrl:"/assets/images/jules-portrait.png"},{name:"Jules",job:"Conseiller Patrimonial",description:"“Ce qui me challenge tous les jours ? <br/> La satisfaction client”",photoUrl:"/assets/images/jules-portrait.png"}].forEach(e=>{document.querySelector(".discover-our-job__card-section__cards").innerHTML+=`
  ...
  `}),document.querySelector(".discover-our-job__card-section__cards");const r=document.querySelectorAll(".discover-our-job__card-section__cards__card");document.querySelectorAll(".discover-our-job__card-section__right-arrow, .discover-our-job__card-section__left-arrow").forEach(e=>e.addEventListener("click",n));let s=0}if(document.querySelector(".join-the-team-section")){let r=function(){if(console.dir(this),this.nextElementSibling.style.maxHeight)console.dir(this.nextElementSibling),this.nextElementSibling.style.maxHeight="",this.lastElementChild.style.transform="rotate(0deg)";else{const s=this.nextElementSibling.scrollHeight;this.nextElementSibling.style.maxHeight=`${s}px`,this.lastElementChild.style.transform="rotate(180deg)"}};var handleClick=r;document.querySelectorAll(".join-the-team-section__offer-container__offer-btn").forEach(s=>s.addEventListener("click",r))}if(document.querySelector(".piloted-graph-section")){let s=function(){r.innerHTML="",l.forEach(u=>u.classList.remove("piloted-graph-section__btns-container__btn--active")),this.classList.add("piloted-graph-section__btns-container__btn--active");const t=this.getAttribute("data-attr"),d=o[t][o[t].length-1].percentage;o[t].forEach((u,v)=>{const b=u.percentage*100/d;r.innerHTML+=`
    <div
    ...
    </div>`;const g=document.querySelector(`.piloted-graph-section__graph-container__bar-container__bar-graph--${v}`);g.style.maxHeight="0",g.style.opacity="0",setTimeout(()=>{const m=document.querySelector(`.piloted-graph-section__graph-container__bar-container__bar-graph--${v}`);m.style.maxHeight=`${b}%`,m.style.opacity="1",n(m,u.percentage,500)},10)})},n=function(t,d,u){const g=u/10;let m=0;const f=(d-0)/g;function h(){m+=f,m>=d?t.textContent=`${d} %`:(t.textContent=`${m.toFixed(1)} %`,setTimeout(h,10))}h()};var handleClick=s,animateNumber=n;const o=[[{percentage:3.3,description:"Prudent"},{percentage:8.4,description:"Equilibré"},{percentage:11.9,description:"Dynamique"}],[{percentage:5.3,description:"Prudent"},{percentage:9.4,description:"Equilibré"},{percentage:15.8,description:"Dynamique"}],[{percentage:7.3,description:"Prudent"},{percentage:10.4,description:"Equilibré"},{percentage:16.9,description:"Dynamique"}]],r=document.querySelector(".piloted-graph-section__graph-container"),l=document.querySelectorAll(".piloted-graph-section__btns-container__btn");l.forEach(t=>t.addEventListener("click",s));const c=o[1][o[1].length-1].percentage;o[1].forEach(t=>{const d=t.percentage*100/c;r.innerHTML+=`
    <div
      class="piloted-graph-section__graph-container__bar-container"
